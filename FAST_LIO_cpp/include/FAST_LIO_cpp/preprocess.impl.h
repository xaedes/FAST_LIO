...
Preprocess_<TCommon>::Preprocess_()
...
template<class TCommon>
void Preprocess_<TCommon>::set(bool feat_en, int lid_type, double bld, int pfilt_num)
{
...
template<class TCommon>
void Preprocess_<TCommon>::avia_handler(const PointCloudLivox &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
template<class TCommon>
void Preprocess_<TCommon>::oust64_handler(const PointCloudOuster &pl_orig)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
template<class TCommon>
void Preprocess_<TCommon>::velodyne_handler(const PointCloudVelodyne &pl_orig)
{
    pl_surf.clear();
    pl_corn.clear();
    pl_full.clear();
...
// template<class TCommon>
// void Preprocess_<TCommon>::pub_func(PointCloudXYZI &pl, const ros::Time &ct)
// {
...
template<class TCommon>
int Preprocess_<TCommon>::plane_judge(const PointCloudXYZI &pl, std::vector<orgtype> &types, uint i_cur, uint &i_nex, Eigen::Vector3d &curr_direct)
{
...
template<class TCommon>
bool Preprocess_<TCommon>::edge_jump_judge(const PointCloudXYZI &pl, std::vector<orgtype> &types, uint i, Surround nor_dir)
{
  if(nor_dir == 0)
  {
